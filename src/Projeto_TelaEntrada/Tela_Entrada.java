...
public class Tela_Entrada extends JFrame {
	...
	private void Painel_de_comando() {
		...
		JButton Menu_Principal = new JButton("FINAN�AS");
		Menu_Principal.setBackground(Color.WHITE);
//		ImageIcon image6 = new ImageIcon(getClass().getResource("/informa��es.png"));
//		Menu_Principal.setIcon(image6);
		...
		JLabel Menu_Espaco = new JLabel("Relat�rio");
		...
		JLabel Menu_Versao = new JLabel("Vers�o 1.0.3");
